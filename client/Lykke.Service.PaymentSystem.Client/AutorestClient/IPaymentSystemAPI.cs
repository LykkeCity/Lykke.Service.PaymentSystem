...
namespace Lykke.Service.PaymentSystem.Client.AutorestClient
{
    ...
    public partial interface IPaymentSystemAPI : System.IDisposable
    {
        ...
        /// The cancellation token.
        /// </param>
        Task<HttpOperationResponse<object>> GetSourceClientIdWithHttpMessagesAsync(string walletId = default(string), string clientPaymentSystem = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
